...
void Controller::Start() {
	...
	SetCusorPosition(13, 26);
	std::cout << "Press any key to start...";
	SetCusorPosition(13, 27);
	system("pause");
}
...
void Controller::Select()//选择界面
{
	...
	SetCusorPosition(13, 27);
	std::cout << "                          ";
	SetCusorPosition(6, 21);
	std::cout << "请选择游戏难度：";
	SetCusorPosition(6, 22);
	std::cout << "(上下键选择,回车确认)";
	SetCusorPosition(27, 22);
	SetBackColor();//第一个选项设置背景色以表示当前选中
	std::cout << "简单模式";
	SetCusorPosition(27, 24);
	SetColor(3);
	std::cout << "普通模式";
	SetCusorPosition(27, 26);
	std::cout << "困难模式";
	SetCusorPosition(27, 28);
	std::cout << "炼狱模式";
	SetCusorPosition(0, 31);
	score = 0;
	...
	while ((ch = _getch()))
	{
		...
		case 72://UP上方向键
			if (key > 1)//当此时选中项为第一项时，UP上方向键无效
			{
				...
				{
				case 2:
					SetCusorPosition(27, 22);//给待选中项设置背景色
					SetBackColor();
					std::cout << "简单模式";

					SetCusorPosition(27, 24);//将已选中项取消我背景色
					SetColor(3);
					std::cout << "普通模式";
		...
		SetCusorPosition(0, 31);//将光标置于左下角，避免关标闪烁影响游戏体验
	}
...
void Controller::DrawGame()//绘制游戏界面
{
	...
	/*绘制侧边栏*/
	SetColor(3);
	SetCusorPosition(33, 1);
	std::cout << "Greedy Snake";
	SetCusorPosition(34, 2);
	std::cout << "贪吃蛇";
	SetCusorPosition(31, 4);
	std::cout << "难度：";
	SetCusorPosition(36, 5);
	switch (key)
	{
	case 1:
		std::cout << "简单模式";
	...
	SetCusorPosition(31, 7);
	std::cout << "得分：";
	SetCusorPosition(37, 8);
	std::cout << "     0";
	SetCusorPosition(33, 13);
	std::cout << " 方向键移动";
	SetCusorPosition(33, 15);
	std::cout << " ESC键暂停";
}
...
int Controller::Menu()//选择菜单
{
	/*绘制菜单*/
	SetColor(11);
	SetCusorPosition(32, 19);
	std::cout << "菜单：";
	Sleep(100);
	SetCusorPosition(34, 21);
	SetBackColor();
	std::cout << "继续游戏";
	Sleep(100);
	SetCusorPosition(34, 23);
	SetColor(11);
	std::cout << "重新开始";
	Sleep(100);
	SetCusorPosition(34, 25);
	std::cout << "退出游戏";
	SetCusorPosition(0, 31);
...
int Controller::GameOver()//游戏结束界面
{
	...
	Sleep(500);
	SetColor(11);
	SetCusorPosition(10, 8);
	std::cout << "━━━━━━━━━━━━━━━━━━━━━━";
	Sleep(30);
	SetCusorPosition(9, 9);
	std::cout << " ┃               Game Over !!!              ┃";
	Sleep(30);
	SetCusorPosition(9, 10);
	std::cout << " ┃                                          ┃";
	Sleep(30);
	SetCusorPosition(9, 11);
	std::cout << " ┃              很遗憾！你挂了              ┃";
	Sleep(30);
	SetCusorPosition(9, 12);
	std::cout << " ┃                                          ┃";
	Sleep(30);
	SetCusorPosition(9, 13);
	std::cout << " ┃             你的分数为：                 ┃";
	SetCusorPosition(24, 13);
	std::cout << score;
	Sleep(30);
	SetCusorPosition(9, 14);
	std::cout << " ┃                                          ┃";
	Sleep(30);
	SetCusorPosition(9, 15);
	std::cout << " ┃   是否再来一局？                         ┃";
	Sleep(30);
	SetCusorPosition(9, 16);
	std::cout << " ┃                                          ┃";
	Sleep(30);
	SetCusorPosition(9, 17);
	std::cout << " ┃                                          ┃";
	Sleep(30);
	SetCusorPosition(9, 18);
	std::cout << " ┃    嗯，好的        不了，还是学习有意思  ┃";
	Sleep(30);
	SetCusorPosition(9, 19);
	std::cout << " ┃                                          ┃";
	Sleep(30);
	SetCusorPosition(9, 20);
	std::cout << " ┃                                          ┃";
	Sleep(30);
	SetCusorPosition(10, 21);
	std::cout << "━━━━━━━━━━━━━━━━━━━━━━";

	Sleep(100);
	SetCusorPosition(12, 18);
	SetBackColor();
	std::cout << "嗯，好的";
	SetCusorPosition(0, 31);
